...
public class Snake {
    ...
    public static int BEGIN_SPEED =400;         // tốc độ di chuyển ban đầu
    ...
    public void update(){
        ...
        */
        if(doDai==maxLen) {
            GameScreen.isPlaying=false;//neu do dai ran bang do dai max cua level thi game tam dung;
            resetGame();
            GameScreen.currentLevel++;//len 1 level moi;
            maxLen +=5; 
